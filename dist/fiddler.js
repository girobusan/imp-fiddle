...
class CodeEditor extends preact__WEBPACK_IMPORTED_MODULE_0__.Component{
  ...
  componentDidMount(){
    this.editor = (0,codejar__WEBPACK_IMPORTED_MODULE_3__.CodeJar)(this.container.current , e=>prismjs__WEBPACK_IMPORTED_MODULE_4___default().highlightElement(e) , {tab: '  '});
  }
     ...
     <div class="split vertical" id="mainContainer" ref=${this.mainContainer}>
          ...
          <div class="split horizontal" id="editors" ref=${this.editors}>
             <div class="editorContainer" id="css" ref=${this.cssEditor}>
               <h3>CSS</h3>
               <${_CodeEditor__WEBPACK_IMPORTED_MODULE_4__.CodeEditor} lang="css" />
             </div>
             <div class="editorContainer" id="html" ref=${this.htmlEditor}>

               <h3>HTML</h3>
               <${_CodeEditor__WEBPACK_IMPORTED_MODULE_4__.CodeEditor} lang="html" />
             </div>
             <div class="editorContainer" id="js" ref=${this.jsEditor}>
               <h3>Java Script</h3>
               <${_CodeEditor__WEBPACK_IMPORTED_MODULE_4__.CodeEditor} lang="js" />
             </div>
          </div>
